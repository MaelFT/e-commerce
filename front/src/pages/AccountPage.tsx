    ...
    <PublicLayout>
      <div className="flex-grow bg-[#FDFDFD] py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="mb-8">
            <p className="text-xs font-semibold tracking-wider text-zinc-400 uppercase mb-1">Espace personnel</p>
              ...
              {activeTab === 'profile' && (
                <>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {stats.map((stat) => (
                      <div key={stat.label} className="bg-white border border-zinc-200 rounded-2xl p-5 hover:border-zinc-300 transition-colors">
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            {errors.current_password && (
                              <p className="text-red-500 text-xs">{errors.current_password[0]}</p>
                            )}
                          </div>
                  ...
                  {user?.role === 'admin' && (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-black">Panneau d'administration</p>
                        <p className="text-xs text-zinc-400">Accéder au back-office Filament</p>
                      </div>
